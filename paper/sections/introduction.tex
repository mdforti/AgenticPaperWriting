...
\begin{enumerate}
  ...
  \item \textbf{Local bonding} --- Three families of atom-centred descriptors are compared: bond-order potential (BOP) moments from a canonical tight-binding Hamiltonian~\cite{bopfox}, atomic cluster expansion (ACE)~\cite{ace}, and smooth overlap of atomic positions (SOAP) fingerprints~\cite{soap}.
\end{enumerate}
